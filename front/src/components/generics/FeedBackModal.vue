<script setup>
    ...
    onMounted(() => {
        state.modaDemo = new bootstrapBundle.Modal('#fbModal', {})
        state.modaDemo.hide()
    })
...
<template>
    <div id="fbModal" class="modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-footer">
                <button type="button" @click="hideModal" class="btn btn-danger" data-dismiss="modal" data-backdrop="false">Close</button>
            </div>
            </div>
        </div>
    </div>
